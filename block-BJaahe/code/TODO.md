...
const delayedLog = delay(() => {
  console.log("Delayed log executed!");
}, 1000); 
delayedLog();


const delayedAlert = delay(() => {
  alert("Delayed alert executed!");
}, 2000)
delayedAlert();

// Example 3: Executing a custom function after a delay
const customFunction = () => {
  console.log("Custom function executed!");
};
const delayedCustomFunction = delay(customFunction, 3000); // Wait for 3000 milliseconds (3 seconds)
delayedCustomFunction();
